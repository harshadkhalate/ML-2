...
def func(s: Symptomclass):
    ...
    # Filter out diseases that have probability above the threshold
    pred_diseases = [disease[i] for i, prob in enumerate(pred) if prob > threshold]
    return {
        'disease': pred_diseases
    }
